...
<div id="pt-admin-notice" class="notice notice-info">
	<p>
		<?php esc_html_e( 'You\'re site is currently in test mode. When you are ready, switch to live mode to accept real payments.', 'paytium' ); ?>

        <a href="<?php echo esc_url( admin_url( 'admin.php?page=paytium' ) ); ?>" class="button-primary"
           style="vertical-align: baseline;"><?php esc_html_e( 'Go to Settings', 'paytium' ); ?> &rarr;</a>
