...
<div class="pt-alert pt-alert-info" id="pt-new-mollie-account-email-confirmation" style="display: none;">
        <?php echo wp_kses_post( __( 'You\'ve just created a new Mollie account and will receive a confirmation email.<br />Click the activation URL in that email before you continue!', 'paytium' ) ); ?>
</div>
...
<div id="active-profiles" class="boxed" style="display: none;">
        ...
        <h3><?php esc_html_e( 'Choose a website profile', 'paytium' ); ?></h3>

        <p>
	        <?php esc_html_e( 'Your Mollie account already contains website profiles, you can select one of those or create a new profile below.', 'paytium' ); ?>
	        <?php esc_html_e( 'To view all profiles go to', 'paytium' ); ?>
...
<div id="create-new-profile" class="boxed" style="display: none;">
	...
	<h3><?php esc_html_e( 'Create a new website profile', 'paytium' ); ?></h3>

    <p>
		<?php esc_html_e( 'For every website you want to receive payments on, you will need to create a website profile.', 'paytium' ); ?>
		<?php esc_html_e( 'Complete the below details and create your website profile!', 'paytium' ); ?>
    </p>
	...
	<form method="">
		<div class="form-group">
			<label><?php esc_html_e( 'Name', 'paytium' ); ?>:</label>
            <input type="text" name="name" class="" value="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>">
		</div>
		<div class="form-group">
			<label><?php esc_html_e( 'Website', 'paytium' ); ?>:</label>
            <input type="text" name="website" class="" value="<?php echo esc_attr( site_url() ); ?>">
		</div>
		<div class="form-group">
			<label><?php esc_html_e( 'Email', 'paytium' ); ?>:</label>
            <input type="text" name="email" class="" value="<?php echo esc_attr( get_option( 'admin_email' ) ); ?>">
		</div>
		<div class="form-group">
			<label><?php esc_html_e( 'Phone', 'paytium' ); ?>:</label>
            <input type="text" name="phone" class="">
		</div>

		<a href="javascript:void(0);" id="create-mollie-profile" class="button button-primary"
		   style="margin-top: 10px;"><?php esc_html_e( 'Create new website profile', 'paytium' ); ?></a>
...
<div id="profile-connected" class="boxed" style="display: none;">
    <div class="pt-alert pt-alert-success">
        <?php esc_html_e( 'A Mollie website profile is now connected to this site.', 'paytium' ); ?>
    </div>
    ...
    <div style="text-align: center; margin-top: 10px;">
        <a href="javascript:void(0);" class="button button-primary continue-button tab-button"
           data-target="payment-test"><?php esc_html_e( 'Continue to next step', 'paytium' ); ?> &rarr;</a>
    </div>
