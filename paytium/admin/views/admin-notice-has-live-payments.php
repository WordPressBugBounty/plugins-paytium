...
<div id="pt-admin-notice" class="notice notice-warning">
	<p>
		<?php esc_html_e( 'You have already received "live" payments, are you sure you need to go through the Setup Wizard again?', 'paytium' ); ?>

        <a href="<?php echo esc_url( admin_url( 'admin.php?page=paytium' ) ); ?>" class="button-primary"
           style="vertical-align: baseline;"><?php esc_html_e( 'No, back to Settings', 'paytium' ); ?></a>

		<a href="<?php echo esc_url( add_query_arg( 'pt-dismiss-has-live-payments-nag', 1 ) ); ?>"
		   class="button-secondary"><?php esc_html_e( 'Yes, hide this', 'paytium' ); ?></a>
	</p>
</div>
